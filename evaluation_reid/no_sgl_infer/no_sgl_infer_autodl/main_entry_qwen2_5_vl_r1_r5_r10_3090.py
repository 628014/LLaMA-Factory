...
from eval_text2image_r1_r5_r10 import run_iterative_eval
...
# 1. ICFG-PEDES 配置
CAPTION_PATH_ICFG = "/home/wangrui/code/MLLM4Text-ReID-main/data/ICFG-PEDES/ICFG-PEDES_match_score_54522.json"
# 注意：确保这里指向包含所有图片的根目录，而不是子文件夹
IMAGE_PATH_ICFG = "/home/wangrui/code/MLLM4Text-ReID-main/data/ICFG-PEDES/imgs"
...
# 上面正样本太多了  
CACHE_FILE_ICFG_80 = "/home/wangrui/code/LLaMA-Factory/evaluation_reid/backup_data/reid_resnet50_cache/icfg_test_gallery_80_shuffle.json"

# 2. CUHK-PEDES 配置
CAPTION_PATH_CUHK = "/home/wangrui/code/MLLM4Text-ReID-main/data/CUHK-PEDES/reid_raw_match_score_40201.json"
IMAGE_PATH_CUHK = "/home/wangrui/code/MLLM4Text-ReID-main/data/CUHK-PEDES/imgs/"
...
# cuhk的正样本太少了 
CACHE_FILE_CUHK_07 = "/home/wangrui/code/LLaMA-Factory/evaluation_reid/backup_data/reid_resnet50_cache/cuhk_test_gallery_7_shuffle.json"


# 3. RSTPReid 配置
CAPTION_PATH_RSTP = "/home/wangrui/code/MLLM4Text-ReID-main/data/RSTPReid/data_caption_all_qwen_file_path.json"
IMAGE_PATH_RSTP = "/home/wangrui/code/MLLM4Text-ReID-main/data/RSTPReid/imgs/"
# CACHE_FILE_RSTP_50 = "/home/wangrui/code/LLaMA-Factory/evaluation_reid/backup_data/reid_resnet50_cache/rstp_test_gallery_50_shuffle.json"
# CACHE_FILE_RSTP_10 = "/home/wangrui/code/LLaMA-Factory/evaluation_reid/backup_data/reid_resnet50_cache/rstp_test_gallery_10_shuffle.json"
CACHE_FILE_RSTP_30 = "/home/wangrui/code/LLaMA-Factory/evaluation_reid/backup_data/reid_resnet50_cache/rstp_test_gallery_30_shuffle.json"
...
# CACHE_FILE_CUHK_30 = "/root/autodl-tmp/output/reid_resnet50_cache/cuhk_test_gallery_30_shuffle.json"
# # cuhk的正样本太少了 
# CACHE_FILE_CUHK_07 = "/root/autodl-tmp/output/reid_resnet50_cache/cuhk_test_gallery_7_shuffle.json"
# # 3. 选择模型路径进行评估
...
# 新增66k 全量数据微调的模型路径， 其中是原始的2k评估香瓜的变成了8k
# MODEL_PATH = '/root/autodl-tmp/output/merge_lora/lora128_with_progressive_66k_full_autodl'
# 这个是3B的全量16k微调模型
# MODEL_PATH = '/root/autodl-tmp/saves/qwen2_5vl-7b/lora/sft_retpreid/lora64_with_progressive_16k_drop005_bs1_3B_autodl'
# 48k 没有dpo的，但是有stage2初始化的模型
# MODEL_PATH = '/root/autodl-tmp/output/merge_lora/lora128_with_progressive_48k_full_autodl_init_stage2'
...
def main():
    ...
    # target_data = load_pstp_test(CAPTION_PATH_CUHK)
    # target_img_root = IMAGE_PATH_CUHK
    # target_cache = CACHE_FILE_CUHK_07
    ...
    try:
        ...
        # 修改：接收 4 个返回值
        final_r1, final_r5, final_r10, final_map = run_iterative_eval(
            model, 
            processor, 
            target_data, 
            target_img_root, 
        ...
        print(f"Rank-5 : {final_r5:.4f}")
        print(f"Rank-10: {final_r10:.4f}")
